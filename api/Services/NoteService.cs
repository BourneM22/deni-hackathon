...
namespace api.Services
{
    ...
    public class NoteService : INoteService
    {
        ...
        {
            String query = "insert into NOTE (note_id, user_id, title, content, created_date_time, modified_date_time) " +
                "values (?, ?, ?, ?, ?, ?);";
        ...
        public async Task UpdateNote(UpdateNoteRequest updatedNote, String userId)
        {
            String query = "update NOTE " +
                "set title = ?, content = ?, modified_date_time = ? " + 
        ...
        public async Task<List<NoteResponse>> GetAllNotes(String userId)
        {
            ...
            String query = "select note_id, title, content, modified_date_time " +
                "from NOTE " + 
                "where user_id = ?;";
